...
class AadharPay extends StatefulWidget {
  const AadharPay({Key? key, required this.onSubmit}) : super(key: key);
  final ValueChanged<String> onSubmit;

  @override
  State<AadharPay> createState() => _AadharPayState();
}

class _AadharPayState extends State<AadharPay> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      key: _scaffoldKey,
      appBar: CustomAppBar(
          state: _scaffoldKey, appBarName: "Aadhar Pay", isback: true),
      body: isLoading
